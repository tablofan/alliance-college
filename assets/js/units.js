...
(function () {
  ...
  const UNITS = {
    ...
    'cpccbc4009': {
      ...
      section: 'Codes, Standards & Legislation', sectionKey: 'codes',
      status: 'satisfactory', submitted: '11 Apr 2026', score: '13/15',
      ...
      submittedFiles: [['legal-scenario-response.pdf', '950 KB']],
    },
    'cpccbc4002': {
    ...
    'cpcwhs3001': {
      ...
      section: 'WHS & Site Safety', sectionKey: 'whs',
      status: 'satisfactory', submitted: '18 Apr 2026', score: '14/15',
      ...
      submittedFiles: [['hazard-register.xlsx', '440 KB'], ['site-photos.zip', '11.2 MB']],
    },
    'cpccbc4012': {
    ...
    'cpccbc4014': {
      ...
      section: 'Plans, Drawings & Set-Out', sectionKey: 'plans',
      status: 'satisfactory', submitted: '24 Apr 2026', score: '15/15',
    ...
    'cpccbc4018': {
      ...
      submittedFiles: [['setout-report.pdf', '1.2 MB'], ['site-photos.zip', '8.4 MB']],
    },
    'cpccom1015': {
      code: 'CPCCOM1015', title: 'Carry out measurements and calculations',
      section: 'Plans, Drawings & Set-Out', sectionKey: 'plans',
      status: 'satisfactory', submitted: '01 May 2026', score: '14/15',
      ...
      submittedFiles: [['measurements-worksheet.xlsx', '320 KB']],
    },
    'cpccbc4005': {
      ...
      status: 'satisfactory', submitted: '12 May 2026', score: '14/15',
      ...
      submittedFiles: [['procurement-schedule.xlsx', '510 KB']],
    },
    'cpccbc4007': {
